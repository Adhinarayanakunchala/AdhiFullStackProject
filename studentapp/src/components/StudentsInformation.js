          ...
          <tbody>
            {students.map((student) => (
              <tr key={student.iD}>
                ...
                <td>{student.total}</td>
                <td>
                  <i className="btn btn-info btn-sm" onClick={() => showStudent(student.iD)}>
                    Show
                  </i>
                </td>
                <td>
                  <i className="btn btn-success btn-sm" onClick={() => updateStudent(student.iD)}>
                    Update
                  </i>
                </td>
                <td>
                  <i className="btn btn-danger btn-sm" onClick={() => deleteStudent(student.iD)}>
                    Delete
                  </i>
                </td>
              </tr>
